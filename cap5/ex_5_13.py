...
# Fazer uma analise de dados de uma empresa: Ler arquivos csv (tabelas, contendo: quanto que cada funcionário vendeu no mês, nome, idade, telefone),
# ver quem foi o vendendor que vendeu mais, e asssim mandar uma mensagem para o vencendor dizendo o prêmio

# Ainda pensando em outros projetos.....
